...
| `Data_Preprocessing.ipynb` | [cite_start]This script takes the generated data and prepares it for machine learning . It converts all non-numerical categories (like gender and location) into numerical labels using a **LabelEncoder** . |
